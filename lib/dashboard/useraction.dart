    ...
    return Scaffold(
      ...
      value: (item) => stacknotes().where((x)=>x["datetime"]==item["datetime"]).map((x)=>x["username"] ).toList().toSet().length>10?10:stacknotes().where((x)=>x["datetime"]==item["datetime"]).map((x)=>x["username"] ).toList().toSet().length,
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: SingleChildScrollView(
                                                      child: DataTable(
                                                                columns: [
                                                                  DataColumn(label: 
                                                       Text('Event',style: GoogleFonts.paytoneOne(color: text1,fontWeight:FontWeight.normal))),
                                                               ...
                                                               //   DataColumn(label: Text('Unique users',style: GoogleFonts.paytoneOne(color: text1,fontWeight:FontWeight.normal))),
                                                                ...
                                                                ... ['Opened app', 'tutorial','Exited app',  'darkmode', 'lightmode', 'Added','NOtification','Search','Orders are making way to you','Exited app','Agreed' ,'Added', 'Clicked on','darkmode',  'Swiped up', 'Swiped down', 'Swiped right', 'Swiped left'].map((i)=>
             ...
             //   Text('${countuniqueusers(stacknotes().where((x)=>x["datetime"]==leo).map((x)=>x["username"].toString()).toSet().toList(),"hitler","unique_user")}'),
                   ...
                   // Text(  mostRepeatedItems(useraction).toString().replaceAll("[","").replaceAll("]","").toString()),
              ...
              //ge.toString())),
                  //  subtitle:   Text(   useraction.length>0? mostRepeatedItems(useraction.toString()).toString():"useraction.toString()".toString()
                //    ),
              //  r      Text(compareAndAddToList(useraction,['Opened app', 'tutorial','Exited app',  'Switched to dark mode', 'Switched to light mode', 'Clicked on', 'Changed theme to dark mode']).toString()),
