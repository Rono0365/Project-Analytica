...
class poststudent extends StatefulWidget {
  poststudent({super.key, required this.school, required this.title, required this.klass});
...
class _poststudentState extends State<poststudent> {
  ...
  bool pressd = false;
  createSubject(
       String name, String placeTaught, String adm) async {
    ...
    */
    http.Response response1 = await http.post(
       ...
       */
       "profpic":"${widget.title}",
        "School": widget.school,
        "Class": titleController3.text,
        "adm_no": adm,
        "owner": name
