...
class Appointments2 extends StatefulWidget {
  const Appointments2(
      {super.key,
      required this.name,
      required this.token,
  ...
  @override
  State<Appointments2> createState() => _Appointments2State();
}

class _Appointments2State extends State<Appointments2> {
  String imageBase64 = '';
  File? image;
  File? image2;
  File? image3;
  ...
  Future createPost() async {
    ...
    http.Response response1 = await http.post(
      ...
      body: jsonEncode(<String, String>{
        ...
        'title': "Appointments", //an actual title
