...
class FriendMessX2 extends StatefulWidget {
  ...
  @override
  State<FriendMessX2> createState() => _FriendMessX2State();
}

class _FriendMessX2State extends State<FriendMessX2> {
  var now;
  var leo;
  String xrx = '0';
  var indx;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Chip(
              ...
              avatar:
                  const CircleAvatar(radius: 7, backgroundColor: Colors.lightGreen),
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'Send fees notification to ${widget.title}',
